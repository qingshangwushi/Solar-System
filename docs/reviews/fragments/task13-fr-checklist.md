...
| 日期 | 版本 | 变更摘要 | 涉及 FR |
|---|---|---|---|
| 2026-07-16 | v1.0 | 首版 80 条 FR 全量核对 | 全部 |
| 2026-07-17 | v1.1 | 反映本轮 P0/P1/P3 修复成果（E-28/E-24/E-39/E-42 + 4 管线 + catalog/ephemeris/manifest + a11y + 诊断包导出 + 运维脚本） | FR-ASTRO-001/002/008、FR-NAV-002/003、FR-EVENT-002、FR-OFFLINE-001/004/005、FR-BOOT-001（兼容矩阵） |

**本轮新增的对照文档**：`docs/compatibility-matrix.md`（设计 32 节落地）。
